...
| Raw accel+gyro | **Neel Adke** ([@Neel20](https://github.com/Neel20))| Added the `lsm6dsv16xRaw` device type (type 5) exposing raw accelerometer + gyroscope, the gyro CAN registers, and supporting examples. *(Attributed from the source folder provenance; this work was uncommitted in the original tree.)* |
